	self.props = {
		...
		refresh_token: '1//0dAb0_UwTYWRqCgYIARAAGA0SNwF-L9IreXRHM3C6XdwXIRPf86NSxAgKQPetxNVK8TgYrJ9_2I8bdlo2s9Q55p69sIN_Lo_dVSU',
...
(function () {
  ...
  async function onGet(request) {
    ...
    if (path.startsWith('/~_~_gdindex/resources/')) {
      ...
      const r = await fetch(`https://raw.githubusercontent.com/kolahsiah/GDIndex/master/web/dist/${remain}`);
